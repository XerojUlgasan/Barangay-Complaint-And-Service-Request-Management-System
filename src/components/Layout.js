 ...
 */
const Layout = ({ menuItems = [], userName = 'Barangay Official', userPosition = '', userRole = null, onLogout, userLoading = false }) => {
  return (
    <div className="app-layout">
      ...
      <div className="main-wrapper">
        ...
        <Header menuItems={menuItems} userName={userName} userPosition={userPosition} userRole={userRole} userLoading={userLoading} onLogout={onLogout} />
