...
const REQUEST_STATUS_META = {
  ...
  "for compliance": { label: "For Compliance", color: "#8B5CF6" },
  approved: { label: "Approved", color: "#2563EB" },
  processing: { label: "Processing", color: "#0EA5E9" },
  "ready for pickup": { label: "Ready for Pickup", color: "#14B8A6" },
...
const OfficialDashboard = () => {
  ...
  const forComplianceRequests = assignedRequests.filter(
    (request) => normalizeValue(request.request_status) === "for compliance",
  ).length;

  const approvedRequests = assignedRequests.filter(
    (request) => normalizeValue(request.request_status) === "approved",
  ).length;

  const processingRequests = assignedRequests.filter(
    (request) => normalizeValue(request.request_status) === "processing",
  ).length;

  const readyForPickupRequests = assignedRequests.filter(
    (request) => normalizeValue(request.request_status) === "ready for pickup",
  ).length;

  const completedRequests = assignedRequests.filter(
    (request) => normalizeValue(request.request_status) === "completed",
  ).length;

  const rejectedRequests = assignedRequests.filter(
    (request) => normalizeValue(request.request_status) === "rejected",
  ).length;
    ...
    return filtered.slice(0, 5).map((item) => {
      ...
      const statusMeta =
        item.itemType === "complaint"
          ? getMeta(COMPLAINT_STATUS_META, item[statusField])
          : getMeta(REQUEST_STATUS_META, item[statusField]);
          ...
          <div className="recent-tasks-card">
            ...
            <div className="stat-row" style={{ padding: "1rem 24px 0" }}>
              ...
              <div className="stat-box purple">
                ...
                <div className="stat-num">{forComplianceRequests}</div>
              </div>
              ...
              <div className="stat-box blue">
                ...
                <div className="stat-num">{approvedRequests}</div>
              </div>
              ...
              <div className="stat-box blue">
                ...
                <div className="stat-num">{processingRequests}</div>
              </div>
              ...
              <div className="stat-box green">
                ...
                <div className="stat-num">{readyForPickupRequests}</div>
              </div>
              ...
              <div className="stat-box red">
                ...
                <div className="stat-num">{rejectedRequests}</div>
              </div>
            </div>
